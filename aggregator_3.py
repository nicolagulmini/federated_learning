...
class attention_based_aggregator():
    ...
    def __init__(self, number_of_clusters):
        ...
        flatten_image = Flatten()(image)
        weights = Dense(number_of_clusters, activation='softmax', bias_initializer=Ones(), kernel_initializer=Zeros())(flatten_image)
        out = Dot(axes=1)([weights, cluster_outputs])
        out = Dense(10, activation='softmax', bias_initializer=Ones(), kernel_initializer=Ones())(out)
