...
class attention_based_aggregator():
    ...
    def __init__(self, number_of_clusters):
        ...
        weights = Dense(number_of_clusters, activation='softmax', bias_initializer=Ones(), kernel_initializer=RandomNormal(mean=0.0, stddev=0.05, seed=None))(flatten_image) 
